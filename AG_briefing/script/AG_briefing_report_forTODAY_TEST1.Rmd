...
* This is significantly shorter than the deaths doubling time for previous 7 days (`r Td.reportMINUS7[Td.reportMINUS7$variable == 'Scotland deaths','Td.obs']` days; 95%CI: `r Td.reportMINUS7[Td.reportMINUS7$variable == 'Scotland deaths','ci.low']` - `r Td.reportMINUS7[Td.reportMINUS7$variable == 'Scotland deaths','ci.upp']` days).  
* This is significantly shorter than the deaths doubling time for London (9.3 days; 95%CI: 8.7 – 9.9 days) and not different from the deaths doubling time for rUKxL (3.3 days; 95%CI: 3.3 – 3.4 days).  
&nbsp;
