...
```{r fig3, fig.height = 6, fig.width = 12, out.width= "100%"}
...
pairwise.comp$focal<- factor(pairwise.comp$focal, levels = c('Scotland', 'Rest of UK', 'London'))

ggplot(pairwise.comp, aes(x = versus, y = focal, fill= epidemic.diff)) + 
  geom_tile()+
  xlab('')+ylab('')+
  scale_fill_gradient2(low="red", high="forestgreen", midpoint = 0) +
  geom_text(aes(label = epidemic.diff, x = versus, y = focal), size = 4, fontface = 2)+
...
**Figure 6. Pairwise epidemic progression comparison**.
