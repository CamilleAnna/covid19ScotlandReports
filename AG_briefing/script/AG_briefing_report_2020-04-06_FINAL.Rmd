...
* NOTE: Due to a delay in reporting over weekends, we expect to see an increase in the number of cases and the number of deaths reported in the coming days. Doubling time estimates are therefore subject to change and current estimates may not be an accurate reflection of the situation on the frontline.  
&nbsp;
