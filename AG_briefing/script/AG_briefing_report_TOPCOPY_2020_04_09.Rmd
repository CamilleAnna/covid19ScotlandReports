...
**The epidemic in Scotland is ~8-12 days behind London and is now growing at a faster rate but is slowing down.**  
...
* The epidemic in Scotland is 12.1 days behind London and 3.5 days behind rUKxL (Figure 1).  
...
* This is significantly shorter than the doubling time for deaths for the previous 7 days (`r Td.reportMINUS7[Td.reportMINUS7$variable == 'Scotland deaths','Td.obs']` days; 95%CI: `r Td.reportMINUS7[Td.reportMINUS7$variable == 'Scotland deaths','ci.low']` - `r Td.reportMINUS7[Td.reportMINUS7$variable == 'Scotland deaths','ci.upp']` days).  
* This is significantly shorter than the deaths doubling time for London (9.3 days; 95%CI: 8.7 – 9.9 days) and not significantly different from the deaths doubling time for rUKxL (3.3 days; 95%CI: 3.3 – 3.4 days).  
&nbsp;
...
* This is significantly longer than the doubling time for the previous 7 days (`r Td.reportMINUS7[Td.reportMINUS7$variable == 'Scotland cases','Td.obs']` days; 95%CI: `r Td.reportMINUS7[Td.reportMINUS7$variable == 'Scotland cases','ci.low']` - `r Td.reportMINUS7[Td.reportMINUS7$variable == 'Scotland cases','ci.upp']` days).  
* The current doubling time in Scotland is significantly shorter than London  (`r Td.report[Td.report$variable == 'London cases','Td.obs']` days, 95%CI: `r Td.report[Td.report$variable == 'London cases','ci.low']` - `r Td.report[Td.report$variable == 'London cases','ci.upp']` days) and is significantly longer than rUKxL (`r Td.report[Td.report$variable == 'Rest of UK cases','Td.obs']` days, 95%CI: `r Td.report[Td.report$variable == 'Rest of UK cases','ci.low']` - `r Td.report[Td.report$variable == 'Rest of UK cases','ci.upp']` days) over the same time period (Figure 2).  
...
- Death count for UK from https://www.arcgis.com/apps/opsdashboard/index.html#/f94c3c90da5b4e9f9  a0b19484dd4bb14  (accessed 1000 09/04/2020).  
